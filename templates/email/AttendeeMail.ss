...
<head>
    ...
    <title><%t AttendeeMail.TITLE 'Your ticket for {event}' event=$Event.Title %></title>
</head>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 0;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;box-sizing: border-box;">
                                ...
                                <tr style="margin: 0;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;box-sizing: border-box;">
                                    <td class="content-block lead-block" style="margin: 0;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;box-sizing: border-box;vertical-align: top;font-size: 14px;padding: 20px;">
                                        <h2 class="aligncenter" style="margin: 0;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, &quot;Lucida Grande&quot;, sans-serif;box-sizing: border-box;color: #000;line-height: 1.2em;font-weight: 400;font-size: 24px;text-align: center;"><%t AttendeeMail.CONTENT 'Hi {name}, Here is your entry ticket for <a href="{link}">{event}</a>.' name=$Name event=$Event.Title link=$Event.AbsoluteLink %> </h2>
                                    </td>
                                </tr>
                                <tr style="margin: 0;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;box-sizing: border-box;">
                                        ...
                                        <table class="ticket" style="margin: 0;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;box-sizing: border-box;">
                                            <tr style="margin: 0;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;box-sizing: border-box;">
                                                ...
                                                <td style="vertical-align: middle;margin: 0;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;box-sizing: border-box;font-size: 14px;">
                                                    <p style="margin: 0;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;box-sizing: border-box;margin-bottom: 10px;font-weight: normal;">$Ticket.Title</p>
                                                    <h3 style="margin: 0;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, &quot;Lucida Grande&quot;, sans-serif;box-sizing: border-box;color: #000;line-height: 1.2em;font-weight: 400;font-size: 18px;">$Event.Title</h3>
                                                    <% with $Event.Controller.CurrentDate %>
                                                        <p style="margin: 0;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;box-sizing: border-box;margin-bottom: 10px;font-weight: normal;">$DateRange,<% if $AllDay %> <%t CalendarDateTime.ALLDAY 'Allday' %><% else_if $StartTime  %> $TimeRange<% end_if %></p>
                                                    <% end_with %>
                                                    <p style="margin: 0;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;box-sizing: border-box;margin-bottom: 10px;font-weight: normal;">$Event.Location</p>
                                                    <p style="margin: 0;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;box-sizing: border-box;margin-bottom: 10px;font-weight: normal;">
